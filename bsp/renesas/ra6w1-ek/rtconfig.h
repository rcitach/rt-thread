...
#define RT_LWIP_TCP_SEG_NUM 128
...
#define RT_LWIP_ETHTHREAD_MBOX_SIZE 128
...
#define SOC_FAMILY_RENESAS_RA_WIRELESS
#define SOC_SERIES_R7SA6W1
...
/* Wi-Fi / lwIP throughput tuning */

#define RT_LWIP_UDP_RECVMBOX_SIZE 128
#define RT_LWIP_MEMP_NUM_NETBUF 128
#define RT_LWIP_TCPIP_MSG_INPKT_NUM 128
#define RT_LWIP_TCP_RECVMBOX_SIZE 128
#define RT_LWIP_MEM_SIZE 65536
#define RT_LWIP_PBUF_STRUCT_NUM 64
#define RT_LWIP_CHECKSUM_ON_COPY
#define RT_LWIP_RECV_BUFSIZE_DEFAULT 65536
/* end of Wi-Fi / lwIP throughput tuning */
