 ...
 * \{
 * \addtogroup SYS_TRNG System True Random Number Generator
 *
 ...
 *         stdlib's RAND_MAX.
 */
__RETAINED_CODE uint32_t sys_trng_rand(void);
 ...
 */
void sys_trng_get_bytes(void *buffer, size_t size);
...
/**
 * \brief Reset TRNG source. If hw_trng is available, fifo is flushed and reloaded.
 *
 */
void sys_trng_stir(void);
