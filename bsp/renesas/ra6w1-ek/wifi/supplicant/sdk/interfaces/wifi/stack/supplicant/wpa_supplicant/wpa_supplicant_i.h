...
struct wpa_global {
	...
	int wifi_display;
#define MAX_WFD_SUBELEMS 10		// 12->10	//MODIFY_SUPPLICANT_FOR_FREERTOS
 ...
 */
static inline int external_scan_running(struct wpa_radio *radio)
{
...
//#endif  /* CONFIG_P2P_UNUSED_CMD */
    ...
    u8 delayed_mic_error_enabled;		//MODIFY_SUPPLICANT_FOR_FREERTOS
...
#ifdef  CONFIG_RECONNECT_OPTIMIZE /* by Shingu 20170718 (Scan Optimization) */	//MODIFY_SUPPLICANT_FOR_FREERTOS
    unsigned int reassoc_freq;
    unsigned int reassoc_try;
#endif  /* CONFIG_RECONNECT_OPTIMIZE */

#ifdef CONFIG_SCAN_WITH_BSSID	//MODIFY_SUPPLICANT_FOR_FREERTOS
...
#define WILDCARD_SSID_SCAN ((struct wpa_ssid *) 1)
    ...
    struct wpa_blacklist *blacklist;	//MODIFY_SUPPLICANT_FOR_FREERTOS
     ...
     */
    int extra_blacklist_count;			//MODIFY_SUPPLICANT_FOR_FREERTOS
...
#define MAX_SCAN_ID 2	// 16->2 //MODIFY_SUPPLICANT_FOR_FREERTOS
    ...
    unsigned int drv_smps_modes;	//MODIFY_SUPPLICANT_FOR_FREERTOS
...
#endif	// CONFIG_WPS
    int blacklist_cleared;		//MODIFY_SUPPLICANT_FOR_FREERTOS
	int bssid_ignore_cleared;
...
#if	1	//MODIFY_SUPPLICANT_FOR_FREERTOS, #ifdef CONFIG_SME --> #if 1
	struct {
		u8 ssid[SSID_MAX_LEN];
		size_t ssid_len;
		int freq;
		u8 assoc_req_ie[200];		//MODIFY_SUPPLICANT_FOR_FREERTOS 1500->200
...
#if defined(CONFIG_AP) || defined(CONFIG_P2P) || defined(SUPPORT_DUAL_STATION)	//MODIFY_SUPPLICANT_FOR_FREERTOS
	u8 pending_interface_addr[ETH_ALEN];
	char pending_interface_name[16];		//MODIFY_SUPPLICANT_FOR_FREERTOS 100->16
	int pending_interface_type;
#endif	// defined(CONFIG_AP) || defined(CONFIG_P2P) || defined(SUPPORT_DUAL_STATION)
...
#define MAC_ADDR_RAND_ALL        (MAC_ADDR_RAND_SCAN | \
	...
	int bss_trans_mgmt_in_progress;
...
int wpas_twt_send_setup(struct wpa_supplicant *wpa_s, u8 dtok, int exponent,
			...
			int requestor, int trigger, int implicit,
			int flow_type, u8 flow_id, int protection,
...
int ra6wx_scan_results_timer(void *timeout_ctx, int timeout);
