	...
	u8 mschapv2_id, const u8 *auth_challenge)
{
	...
	ms_len = (int) (sizeof(*ms) + 1 + sizeof(*r) + identity_len);
	resp = eap_msg_alloc(EAP_VENDOR_IETF, EAP_TYPE_MSCHAPV2, (size_t) ms_len,
	...
	WPA_PUT_BE16(ms->ms_length, (u16) ms_len);
