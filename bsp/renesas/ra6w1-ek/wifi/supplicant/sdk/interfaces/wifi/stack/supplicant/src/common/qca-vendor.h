...
enum qca_wlan_vendor_attr_config {
	 ...
	 * value of enum fc80211_chan_width: FC80211_CHAN_WIDTH_5 means 5 MHz,
	 * FC80211_CHAN_WIDTH_10 means 10 MHz. If set, the device work in 5 or
	 * 10 MHz channel width, the station will not connect to a BSS using 20
	 * MHz or higher bandwidth. Set to FC80211_CHAN_WIDTH_20_NOHT to
 ...
 *	values are enumerated in enum %fc80211_band (although not all
...
enum qca_wlan_vendor_attr_external_acs_event {
	...
	/* Operating mode (u8) of interface. Takes one of enum fc80211_iftype
	 * values.
	 */
	QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_EVENT_SAP_MODE = 6,
	/* Channel width (u8). It takes one of enum fc80211_chan_width values.
 ...
 * Takes one of enum fc80211_chan_width values.
 *
...
enum qca_wlan_vendor_attr_external_acs_channels {
	...
	/* Channel width (u8). Takes one of enum fc80211_chan_width values. */
...
enum qca_wlan_vendor_attr_spectral_scan {
	 ...
	 * fc80211_chan_width. This is an optional attribute.
 ...
 * BW of measurement, attribute uses the values in enum fc80211_chan_width
 ...
 * numerated in enum fc80211_band (although not all bands may be supported
 * by a given device).
 *
 ...
 * &struct fc80211_sta_flag_update for the respective connected link. MAC
 ...
 * enum fc80211_iftype. If an interface is marked as restricted the driver must
...
enum qca_wlan_vendor_attr_add_sta_node_params {
	 ...
	 * defined in enum fc80211_auth_type.
	 */
 ...
 * QCA_WLAN_VENDOR_ATTR_CHAN_INFO_BANDWIDTH is set to FC80211_CHAN_WIDTH_80P80.
 *
 * @QCA_WLAN_VENDOR_ATTR_CHAN_INFO_BANDWIDTH:
 * u32 attribute, required. Indicates the bandwidth of the channel, possible
 * values are defined in enum fc80211_chan_width.
 *
 ...
 * defined in enum fc80211_iftype.
 *
 */
 ...
 * fc80211_band. Optional attribute, if not present in the request the driver
 ...
 * interface types defined in enum fc80211_iftype. Optional attribute, if not
