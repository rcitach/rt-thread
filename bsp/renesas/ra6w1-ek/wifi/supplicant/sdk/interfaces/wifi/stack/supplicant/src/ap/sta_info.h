...
#define	INACTIVE_CHECK_INTERVAL	30		//MODIFY_SUPPLICANT_FOR_FREERTOS
...
struct sta_info {
    ...
    unsigned long last_rx_data_packets; //20160316_trinity, added
...
#endif /* CONFIG_PASN */
    u8 is_first_try_done_for_ap_send_ka;
};
