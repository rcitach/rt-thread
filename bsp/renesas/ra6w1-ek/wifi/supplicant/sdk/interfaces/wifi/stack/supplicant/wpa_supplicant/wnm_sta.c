...
#define WNM_NOT_USED //[temp-231122] build error
			       ...
			       u8 pref)
{
	...
	u32 info;
	struct def_ieee80211_ht_operation *ht_oper = NULL;
	struct def_ieee80211_vht_operation *vht_oper = NULL;

	ie = wpa_bss_get_ie(bss, WLAN_EID_HT_OPERATION);
	if (ie && ie[1] >= 2) {
		ht_oper = (struct def_ieee80211_ht_operation *) (ie + 2);
	...
	if (ie && ie[1] >= 1) {
		vht_oper = (struct def_ieee80211_vht_operation *) (ie + 2);
...
static void wnm_dump_cand_list(struct wpa_supplicant *wpa_s)
{
    ...
    printf("\n==========================================================================================\n");
	printf(" WNM: BSS Transition Candidate List\n");
    printf("------------------------------------------------------------------------------------------\n");
