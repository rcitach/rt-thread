...
#ifdef  CONFIG_IEEE80211F    //MODIFY_SUPPLICANT_FOR_FREERTOS
...
#define MESH_ENABLED BIT(0)
    ...
    u16 set_greenfield;        //MODIFY_SUPPLICANT_FOR_FREERTOS
    u8 ht_protection;        //MODIFY_SUPPLICANT_FOR_FREERTOS
...
struct he_phy_capabilities_info {
    int he_su_beamformer;
    int he_su_beamformee;
    int he_mu_beamformer;
};
...
#if 1 // def  CONFIG_IEEE80211AC. 
// note: for compile to work. zero-ed field has no effect in ops, so enabled these fields
    u32 vht_capab;
    int ieee80211ac;
    int require_vht;
    u8 vht_oper_chwidth;
