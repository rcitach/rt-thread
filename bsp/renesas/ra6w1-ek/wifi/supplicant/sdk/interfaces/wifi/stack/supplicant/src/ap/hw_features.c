...
extern int ra6w1_regdb_get_dfs_domain(char* country);
...
int hostapd_get_hw_features(struct hostapd_iface *iface)
{
    ...
    // get dfs_domain
    memset(cnty_str, 0x00, 3);
    memcpy(cnty_str, iface->conf->country, 2);
    dfs_domain = ra6w1_regdb_get_dfs_domain(cnty_str);
    ...
    wpa_printf(MSG_DEBUG, "[%s:%d] dfs_domain = %d \n", __func__, __LINE__, iface->dfs_domain);
