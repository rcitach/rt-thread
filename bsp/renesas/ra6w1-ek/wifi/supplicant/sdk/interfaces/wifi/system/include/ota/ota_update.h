...
#define OTA_STOR_UNKNOWN_ADDR       0xFFFFFFFF

#define OTA_STOR_RTOS_SIZE          SF_RTOS_SIZE
#define OTA_STOR_RTOS_0_ADDR        SF_RTOS_0
#define OTA_STOR_RTOS_1_ADDR        SF_RTOS_1

#define OTA_STOR_USER_SIZE          SF_USER_AREA_SIZE
#define OTA_STOR_USER_START         SF_USER_AREA
#define OTA_STOR_USER_END           (SF_USER_AREA + SF_USER_AREA_SIZE)
...
typedef enum {
    ...
    OTA_TYPE_MCU_FW_STREAM,
#endif // __SUPPORT_MATTER_IOT__ || __SUPPORT_AWS_IOT_W__
    /// Unknown value
    OTA_TYPE_UNKNOWN
} ota_update_type;
