...
#if 0 // to avoid having PSK in OPEN mode
#define DEFAULT_KEY_MGMT (WPA_KEY_MGMT_PSK | WPA_KEY_MGMT_IEEE8021X)
#else
#define DEFAULT_KEY_MGMT WPA_KEY_MGMT_NONE
#endif // to avoid having PSK in OPEN mode
...
#define DEFAULT_GREENFIELD		0
#define DEFAULT_HT_PROTECTION	0
#define DEFAULT_RTS_THRESHOLD	2347

/* Beacon interval default value */
#define BEACON_INT_DEFAULT	    100		/* default : 100msec */
#define DTIM_PERIOD_DEFAULT		2		/* default : 1 or 2 */
#define ISOLATE_DEFAULT			0		/* 0 : Enable Bridge */
#define FREQUENCE_DEFAULT		2412	/* channel 1 */
#define MACADDR_ACL_DEFAULT		9		/* CLEAR */
...
enum wpas_mode {
	WPAS_MODE_INFRA = 0,    // station
	WPAS_MODE_IBSS = 1,     // not support
	WPAS_MODE_AP = 2,       // softap
	WPAS_MODE_P2P_GO = 3,   // p2p go fixed
	WPAS_MODE_P2P_GROUP_FORMATION = 4,  // p2p
	WPAS_MODE_MESH = 5,     // mesh point
};
...
//#ifdef  CONFIG_P2P
    ...
    /**
     * p2p_force - P2P GO SSID and Passphrase forced
     */
	int p2p_force;	//MODIFY_SUPPLICANT_FOR_FREERTOS - add
...
//#endif  /* CONFIG_P2P */
    ...
    /**
     * require_ht - Require HT (IEEE 802.11n) for this network
     *
     * By default, use it if it is available, but this can be configured
     * to 1 to only accept 11n stations.
     */
    int require_ht;

    /**
     * Wi-Fi mode setting
     * 0 = WIFI_MODE_AUTO_STA,  //Station 11b/g/n/ax/a/n(5G)
     * 0 = WIFI_MODE_BGN,       //SoftAP
     * 0 = WIFI_MODE_BGN,
     * 1 = WIFI_MODE_GN,
     * 2 = WIFI_MODE_BG,
     * 3 = WIFI_MODE_N_ONLY,
