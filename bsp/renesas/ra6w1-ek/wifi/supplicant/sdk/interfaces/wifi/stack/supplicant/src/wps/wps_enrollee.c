...
static struct wpabuf * wps_build_m1(struct wps_data *wps)
{
	...
	if (wps->wps->ap && !wps->pbc_in_m1 &&
		 ...
		 * workaround.
		 */
		config_methods &= (u16) ~WPS_CONFIG_PUSHBUTTON;
		config_methods &= (u16) ~(WPS_CONFIG_VIRT_PUSHBUTTON |
...
static int wps_build_cred_ssid(struct wps_data *wps, struct wpabuf *msg)
{
	...
	wpabuf_put_be16(msg, (u16) wps->wps->ssid_len);
...
static int wps_build_cred_network_key(struct wps_data *wps, struct wpabuf *msg)
{
	...
	wpabuf_put_be16(msg, ATTR_NETWORK_KEY);
	wpabuf_put_be16(msg, (u16) wps->wps->network_key_len);
