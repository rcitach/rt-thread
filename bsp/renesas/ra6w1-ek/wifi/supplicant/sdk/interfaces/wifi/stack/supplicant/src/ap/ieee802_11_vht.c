...
u8 * hostapd_eid_vht_operation(struct hostapd_data *hapd, u8 *eid)
{
	...
	struct def_ieee80211_vht_operation *oper;
#else
		      ...
		      const u8 *vht_oper)
{
	...
	if (!sta->vht_operation) {
		sta->vht_operation =
#if 1 //[temp-230516]build error
			os_zalloc(sizeof(struct def_ieee80211_vht_operation));
#else
...
#if 1 //[temp-230516]build error
		  sizeof(struct def_ieee80211_vht_operation));
#else
...
#if 1 //[temp-230516]build error
		  2 + sizeof(struct def_ieee80211_vht_operation));
#else
