...
#define SUPPORT_MBEDTLS_TESTSUITE_PRIMITIVE_HASH_ZERO
...
#if !defined(SUPPORT_MBEDTLS_TESTSUITE_PRIMITIVE_HASH_ZERO)
	if (stat == 1) {
		err = ECWRST_DSA_VERIFY_2MUL_FACTOR_A_NULL_ERROR;
		goto End;
	}
#endif  //SUPPORT_MBEDTLS_TESTSUITE_PRIMITIVE_HASH_ZERO
