...
)
{
	...
	if(keyStatus == CC_FFCDH_KEY_STATIC) {
		...
		// err fix : 'previousKeySize' may be used uninitialized in this function [-Werror=maybe-uninitialized]
		previousKeySize = 0;
		// err fix : 'pPublKeySizeBytes' may be used uninitialized in this function [-Werror=maybe-uninitialized]
		pPublKeySizeBytes = NULL;
		// err fix : 'pPublKey32' may be used uninitialized in this function [-Werror=maybe-uninitialized]
		pPublKey32 = 0;
	}
...
//        pBaseAddr = &pDhCtx->extendDataBuffer[0];
	...
	if(keyStatus == CC_FFCDH_KEY_STATIC) {
		...
		// err fix : 'pPublKeySize' may be used uninitialized in this function [-Werror=maybe-uninitialized]
		pPublKeySize = NULL;
		// err fix : 'pPrivKeySize' may be used uninitialized in this function [-Werror=maybe-uninitialized]
		pPrivKeySize = NULL;
		// err fix : 'testBit' may be used uninitialized in this function [-Werror=maybe-uninitialized]
		testBit = 0;
		// err fix : 'pPrivKey32' may be used uninitialized in this function [-Werror=maybe-uninitialized]
		pPrivKey32 = NULL;
		// err fix : 'pPublKey32' may be used uninitialized in this function [-Werror=maybe-uninitialized]
		pPublKey32 = NULL;
	}
