 ...
 */
#define SUPPORT_PKA_EC_WRST_SMUL_SCAP
#ifdef  SUPPORT_PKA_EC_WRST_SMUL_SCAP
...
CCError_t PkaEcWrstScalarMult(const CCEcpkiDomain_t *pDomain,   /*!< [in] Pointer to EC domain. */
                             ...
                             const uint32_t       *inPointX,       /*!< [in] Pointer to input point X coordinate. */
                             const uint32_t       *inPointY,       /*!< [in] Pointer to input point Y coordinate. */
                             uint32_t             *outPointX,      /*!< [out] Pointer to output point X coordinate. */
...
#endif  //SUPPORT_PKA_EC_WRST_SMUL_SCAP
