...
{
#if     defined(CRYPTO_MALLOC)
    return CRYPTO_MALLOC(aSize);
#else   //defined(CRYPTO_MALLOC)
    return pvPortMalloc(aSize);
#endif  //defined(CRYPTO_MALLOC)
...
{
#if     defined(CRYPTO_REALLOC)
    return CRYPTO_REALLOC(aBuffer, aNewSize);
#else   //defined(CRYPTO_REALLOC)
    return pvPortRealloc(aBuffer, aNewSize);
#endif  //defined(CRYPTO_REALLOC)
...
{
#if     defined(CRYPTO_FREE)
    CRYPTO_FREE(aBuffer);
#else   //defined(CRYPTO_FREE)
    vPortFree(aBuffer);
#endif  //defined(CRYPTO_FREE)
