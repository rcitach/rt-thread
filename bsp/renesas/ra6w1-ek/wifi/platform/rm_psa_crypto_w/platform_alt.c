 ...
 *
 * Example:
 * @snippet rm_psa_crypto_w_example.c PSA_CRYPTO-PLATFORM-SETUP
 *
...
int mbedtls_platform_setup (mbedtls_platform_context * ctx)
{
    ...
    // remove ::: iret = HW_SCE_McuSpecificInit();
 ...
 *
 * Example:
 * @snippet rm_psa_crypto_w_example.c PSA_CRYPTO-PLATFORM-TEARDOWN
 *
 * @retval  N/A
 **********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * @} (end addtogroup RM_PSA_CRYPTO_W)
 **********************************************************************************************************************/
