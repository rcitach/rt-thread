...
/* TIN-TODO: Is this going to be implemented? If not, the dead code should be removed. */
#if 0

// TODO : we need a hotfix for this file.

/*
 * Write the ECParameters record corresponding to a group (RFC 4492)
 */
static int mbedtls_ecp_tls_write_group_edwards (const mbedtls_ecp_group * grp,
                                                size_t                  * olen,
                                                unsigned char           * buf,
                                                size_t                    blen)
{
 ...
 *      } ServerECDHParams;
 */
int mbedtls_ecdh_make_params_edwards (mbedtls_ecdh_context * ctx,
                                      size_t * olen,
                                      unsigned char * buf,
                                      size_t blen,
                                      int (* f_rng)(void *, unsigned char *, size_t),
 ...
 *      } ServerECDHParams;
 */
int mbedtls_ecdh_read_params_edwards (mbedtls_ecdh_context * ctx, const unsigned char ** buf, const unsigned char * end)
{
    int ret;
