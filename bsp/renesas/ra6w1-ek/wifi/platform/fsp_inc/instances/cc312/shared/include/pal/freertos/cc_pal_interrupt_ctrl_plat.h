 ...
 *
 * SPDX-License-Identifier: BSD-3-Clause OR Arm�셲 non-OSI source license
 */
...
typedef  void eIrqReturn;
#define   IRQ_HANDLED

//#define CRYPTOCELL_INTERRUPT CC312_IRQn /*Connected to HOST_IRR*/
#define CRYPTOCELL_INTERRUPT (40)
