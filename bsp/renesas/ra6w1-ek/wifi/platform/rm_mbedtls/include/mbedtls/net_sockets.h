...
/** Not supported. */
#define MBEDTLS_ERR_NET_NOT_SUPPORTED                     -0x0050
#define MBEDTLS_ERR_NET_ALREADY_EXIST                     -0x0051
...
int mbedtls_net_connect_with_bind(mbedtls_net_context *ctx, const char *host,
