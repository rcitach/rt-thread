...
static const char * const g_psHTTPHeaderStrings[] =
{
 ...
 #endif
    ,
    "\r\n<html><body><h2>507: Insufficient Storage</h2><p>The server cannot store the representation needed to complete the request. The filesystem is full.</p></body></html>\r\n"
 #if LWIP_HTTPD_SUPPORT_11_KEEPALIVE
    ,
    "Connection: keep-alive\r\nContent-Length: 175\r\n\r\n<html><body><h2>507: Insufficient Storage</h2><p>The server cannot store the representation needed to complete the request. The filesystem is full.</p></body></html>\r\n"
 #endif
...
/* Indexes into the g_psHTTPHeaderStrings array */
 ...
 #define HTTP_HDR_INSUFFICIENT_STORAGE       4  /* 507 Insufficient Storage */
 #define HTTP_HDR_OK_11                      5  /* 200 OK */
 #define HTTP_HDR_NOT_FOUND_11               6  /* 404 File not found */
 #define HTTP_HDR_BAD_REQUEST_11             7  /* 400 Bad request */
 #define HTTP_HDR_NOT_IMPL_11                8  /* 501 Not Implemented */
 #define HTTP_HDR_INSUFFICIENT_STORAGE_11    9  /* 507 Insufficient Storage */
 #define HTTP_HDR_CONTENT_LENGTH             10 /* Content-Length: (HTTP 1.0)*/
 #define HTTP_HDR_CONN_CLOSE                 11 /* Connection: Close (HTTP 1.1) */
 #define HTTP_HDR_CONN_KEEPALIVE             12 /* Connection: keep-alive (HTTP 1.1) */
 #define HTTP_HDR_KEEPALIVE_LEN              13 /* Connection: keep-alive + Content-Length: (HTTP 1.1)*/
 #define HTTP_HDR_SERVER                     14 /* Server: HTTPD_SERVER_AGENT */
 #define DEFAULT_404_HTML                    15 /* default 404 body */
 #if LWIP_HTTPD_SUPPORT_11_KEEPALIVE
  #define DEFAULT_404_HTML_PERSISTENT        16 /* default 404 body, but including Connection: keep-alive */
 #endif
 #define DEFAULT_507_HTML                    17 /* default 507 Insufficient Storage body */
 #if LWIP_HTTPD_SUPPORT_11_KEEPALIVE
  #define DEFAULT_507_HTML_PERSISTENT        18 /* default 507 body, but including Connection: keep-alive */
 #endif

 #define HTTP_CONTENT_TYPE(contenttype)          "Content-Type: "contenttype "\r\n\r\n"
 #define HTTP_CONTENT_TYPE_ENCODING(contenttype, \
                                    encoding)    "Content-Type: "contenttype "\r\nContent-Encoding: "encoding "\r\n\r\n"

 #define HTTP_HDR_HTML            HTTP_CONTENT_TYPE("text/html")
 #define HTTP_HDR_SSI             HTTP_CONTENT_TYPE( \
