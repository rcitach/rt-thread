...
#if 1	// MODIFY_SUPPLICANT_FOR_FREERTOS - chg

#define os_memcpy(d, s, n)		memcpy(d, s, n)
#define os_memmove(d, s, n)		memmove(d, s, n)
#define os_memset(s, c, n)		memset(s, c, n)
#define os_memcmp(s1, s2, n)	memcmp(s1, s2, n)
#define os_memdup(s, n)			memdup(s, n)
...
static inline void os_strupr(char str[])
{
    int i = 0;
    while (str[i])
    {
...
static inline void os_strlwr(char str[])
{
    int i = 0;
    while (str[i]) {
        if (str[i] >= 'A' && str[i] <= 'Z') {
...
#else /* WPA_TRACE */
#ifndef os_malloc
#define os_malloc(s) pvPortMalloc(s)				// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
#ifndef os_realloc
#define os_realloc(p, s) realloc(p, s)				// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
#ifndef os_free
#define os_free(p) vPortFree(p)						// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
#ifndef os_strdup
#ifdef _MSC_VER
...
#ifndef os_memcpy
#define os_memcpy(d, s, n) memcpy(d, s, n)			// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
#ifndef os_memmove
#define os_memmove(d, s, n) memmove(d, s, n)		// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
#ifndef os_memset
#define os_memset(s, c, n) memset(s, c, n)
#endif
#ifndef os_memcmp
#define os_memcmp(s1, s2, n) memcmp(s1, s2, n)		// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
...
#else
#define os_strcasecmp(s1, s2) strcasecmp(s1, s2)	// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
#endif
...
#else
#define os_strncasecmp(s1, s2, n) strncasecmp(s1, s2, n)	// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
#endif
#ifndef os_strchr
#define os_strchr(s, c) strchr(s, c)				// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
#ifndef os_strcmp
#define os_strcmp(s1, s2) strcmp(s1, s2)			// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
#ifndef os_strncmp
#define os_strncmp(s1, s2, n) strncmp(s1, s2, n)	// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
#ifndef os_strrchr
#define os_strrchr(s, c) strrchr(s, c)				// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
#ifndef os_strstr
#define os_strstr(h, n) strstr(h, n)				// MODIFY_SUPPLICANT_FOR_FREERTOS - FOR_COMPILE
#endif
...
static inline void *memdup(const void *src, size_t len)	//MODIFY_SUPPLICANT_FOR_FREERTOS
{
	void *p;
 #if 0
	p = malloc(len);
