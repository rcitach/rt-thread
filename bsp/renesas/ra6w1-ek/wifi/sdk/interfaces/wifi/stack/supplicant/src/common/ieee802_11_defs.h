...
struct _ieee80211_hdr {        // Avoiding collisions with rwnx_driver
    le16 frame_control;
    le16 duration_id;
    u8 addr1[6];
    u8 addr2[6];
...
#define IEEE80211_HDRLEN          (sizeof(struct _ieee80211_hdr))

#define IEEE80211_FC(type, stype) host_to_le16((type << 2) | (stype << 4))

struct _ieee80211_mgmt {    // Avoiding collisions with rwnx_driver 
    le16 frame_control;
    le16 duration;
    u8 da[6];
    u8 sa[6];
...
struct def_ieee80211_ht_operation {
    u8 primary_chan;
...
struct def_ieee80211_vht_operation {
...
#define WLAN_CIPHER_SUITE_KRK             0x004096FF /* for nld11 use only */
