...
#ifndef BIT     //MODIFY_SUPPLICANT_FOR_FREERTOS
#define BIT(x) (1 << (x))
#endif
...
{
    return !!((unsigned int) akm & (WPA_KEY_MGMT_IEEE8021X |
             WPA_KEY_MGMT_FT_IEEE8021X |
             WPA_KEY_MGMT_FT_IEEE8021X_SHA384 |
             WPA_KEY_MGMT_CCKM |
             WPA_KEY_MGMT_OSEN |
...
{
    return !!((unsigned int) akm & (WPA_KEY_MGMT_PSK |
             WPA_KEY_MGMT_FT_PSK |
...
{
    return !!((unsigned int) akm & WPA_KEY_MGMT_FT);
}

static inline int wpa_key_mgmt_only_ft(int akm)
{
    int ft = wpa_key_mgmt_ft(akm);
    akm = akm & (int) ~WPA_KEY_MGMT_FT;
    return ft && !akm;
}

static inline int wpa_key_mgmt_ft_psk(int akm)
{
    return !!((unsigned int) akm & WPA_KEY_MGMT_FT_PSK);
}

static inline int wpa_key_mgmt_sae(int akm)
{
    return !!((unsigned int) akm & (WPA_KEY_MGMT_SAE |
             WPA_KEY_MGMT_FT_SAE));
}

static inline int wpa_key_mgmt_fils(int akm)
{
    return !!((unsigned int) akm & (WPA_KEY_MGMT_FILS_SHA256 |
             WPA_KEY_MGMT_FILS_SHA384 |
             WPA_KEY_MGMT_FT_FILS_SHA256 |
             WPA_KEY_MGMT_FT_FILS_SHA384));
}
...
{
    return !!((unsigned int) akm & (WPA_KEY_MGMT_PSK_SHA256 |
             WPA_KEY_MGMT_IEEE8021X_SHA256 |
             WPA_KEY_MGMT_SAE |
             WPA_KEY_MGMT_FT_SAE |
             WPA_KEY_MGMT_OSEN |
...
{
    return !!((unsigned int) akm & (WPA_KEY_MGMT_IEEE8021X_SUITE_B_192 |
             WPA_KEY_MGMT_FT_IEEE8021X_SHA384 |
             WPA_KEY_MGMT_FILS_SHA384 |
             WPA_KEY_MGMT_FT_FILS_SHA384));
}
...
{
    return !!((unsigned int) akm & (WPA_KEY_MGMT_IEEE8021X_SUITE_B |
             WPA_KEY_MGMT_IEEE8021X_SUITE_B_192));
}
...
{
    return wpa_key_mgmt_wpa(akm) || (akm & (int) WPA_KEY_MGMT_WPA_NONE);
}
...
{
    return !!((unsigned int)alg & (WPA_AUTH_ALG_FILS | WPA_AUTH_ALG_FILS_SK_PFS));
}
