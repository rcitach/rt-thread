...
#ifndef SUPP_CONFIG_H		//MODIFY_SUPPLICANT_FOR_FREERTOS
...
#define	DEFAULT_MAX_PEER_LINKS				4		//MODIFY_SUPPLICANT_FOR_FREERTOS 99->4
#define	DEFAULT_POINT_MAX_PEER_LINKS		4		//MODIFY_SUPPLICANT_FOR_FREERTOS
#define	DEFAULT_POTAL_MAX_PEER_LINKS		1		//MODIFY_SUPPLICANT_FOR_FREERTOS
...
#define	DEFAULT_BSS_MAX_COUNT				    80				//MODIFY_SUPPLICANT_FOR_FREERTOS
#define	DEFAULT_AP_MAX_INACTIVITY				(5 * 60)		//MODIFY_SUPPLICANT_FOR_FREERTOS
#define	DEFAULT_WPS_DEVICE_TYPE					"0-00000000-0"	//MODIFY_SUPPLICANT_FOR_FREERTOS
#define	DEFAULT_BSS_EXPIRATION_AGE				180
#define	DEFAULT_BSS_EXPIRATION_SCAN_COUNT		2

#if defined (__WPA3_WIFI_CERTFIED__)
  #define DEFAULT_MAX_NUM_STA               7   /* for Anti-clogging test */
#else
  #define DEFAULT_MAX_NUM_STA               6   /* 128 */
#endif /* ... */

#ifdef  CONFIG_CONCURRENT										//MODIFY_SUPPLICANT_FOR_FREERTOS
  #define DEFAULT_CONCURRENT_MAX_NUM_STA    1
#endif  /* CONFIG_CONCURRENT */

#ifdef CONFIG_ACL												//MODIFY_SUPPLICANT_FOR_FREERTOS
#define DEFAULT_ACL_CLEAR                   9
#endif /* CONFIG_ACL */

#define DEFAULT_AP_SSID                     "RTQ61000"			//MODIFY_SUPPLICANT_FOR_FREERTOS
#define DEFAULT_AP_COUNTRY                  "KR"    /* ASCII code : 55 53 */	//MODIFY_SUPPLICANT_FOR_FREERTOS
#define DEFAULT_AP_CHANNEL                  i3ed11_freq_to_ch(FREQUENCE_DEFAULT)//MODIFY_SUPPLICANT_FOR_FREERTOS

#if defined(DPM_MAX_SAE_GROUPS)
#define MAX_SAE_GROUPS                      DPM_MAX_SAE_GROUPS
#else
#define MAX_SAE_GROUPS                      6
#endif /* DPM_MAX_SAE_GROUPS */
...
#define ENV_MANUFACTURER            "manufacturer"
#define ENV_MODEL_NAME              "model_name"
#define ENV_MODEL_NUMBER            "model_number"
#define ENV_SERIAL_NUMBER           "serial_number"
#define ENV_DEVICE_TYPE             "device_type"
#define ENV_CONFIG_METHODS          "config_methods"
#endif /* CONFIG_WPS */
...
#define ENV_PROACTIVE_KEY_CACHING   "proactive_key_caching"
...
#define ENV_AUTOSCAN                "autoscan"
#endif

#ifdef  CONFIG_FAST_REAUTH
#define ENV_FAST_REAUTH				"fast_reauth"
...
#define MAX_WPA_PROFILE             2 //4 // 3
#define PREFIX_NETWORK_PROFILE      "N%d_%s"


#define FIXED_NETWORK_ID_STA        0
#define FIXED_NETWORK_ID_AP         1
#define FIXED_NETWORK_ID_P2P        1
#define FIXED_NETWORK_ID_MESH_POINT 1
#define FIXED_NETWORK_ID_NONE       2
...
struct wpa_config {
    ...
    struct wpa_freq_range_list country_range;
...
#define MAX_SEC_DEVICE_TYPES 5
	...
	int p2p_go_intent;
	char *p2p_ssid_postfix; // SSID_MAX_LEN-(DIRECT-xx) = 32-9 = 32
    ...
    int p2p_find_timeout;   // Unit: 1 second * FC9000 Only ?? * //MODIFY_SUPPLICANT_FOR_FREERTOS-add
...
//#ifndef CONFIG_IMMEDIATE_SCAN		// del MODIFY_RENESAS_ONLY
	/**
...
//#endif	// CONFIG_IMMEDIATE_SCAN
...
#ifdef CONFIG_WPS_NFC	//MODIFY_SUPPLICANT_FOR_FREERTOS
	/**
...
#ifdef CONFIG_EXT_PASSWORD	//MODIFY_SUPPLICANT_FOR_FREERTOS
	/**
...
#ifdef CONFIG_P2P	//MODIFY_SUPPLICANT_FOR_FREERTOS
	/*
...
#ifdef  CONFIG_AP_WMM	//MODIFY_SUPPLICANT_FOR_FREERTOS
...
#ifdef CONFIG_IEEE80211W	//MODIFY_SUPPLICANT_FOR_FREERTOS
	/**
...
#ifdef CONFIG_SAE			//MODIFY_SUPPLICANT_FOR_FREERTOS
	/**
...
#ifdef CONFIG_IGNOR_OLD_SCAN	//MODIFY_SUPPLICANT_FOR_FREERTOS
	/**
...
#ifdef CONFIG_SCHED_SCAN	//MODIFY_SUPPLICANT_FOR_FREERTOS
	/**
    ...
    enum wpas_mode mode;		//MODIFY_SUPPLICANT_FOR_FREERTOS - add
...
#ifdef CONFIG_AP_POWER				//MODIFY_SUPPLICANT_FOR_FREERTOS
    char *ap_power;
#endif /* CONFIG_AP_POWER */

#ifdef CONFIG_ALLOW_ANY_OPEN_AP		//MODIFY_SUPPLICANT_FOR_FREERTOS
...
#ifdef CONFIG_AP_WIFI_MODE			//MODIFY_SUPPLICANT_FOR_FREERTOS
    int wifi_mode;
...
#ifdef CONFIG_WOWLAN			//MODIFY_SUPPLICANT_FOR_FREERTOS
	/**
...
#ifdef CONFIG_RANDOM_ADDR			//MODIFY_SUPPLICANT_FOR_FREERTOS
	/**
...
#ifdef CONFIG_FST			//MODIFY_SUPPLICANT_FOR_FREERTOS
	/**
...
#ifdef CONFIG_GAS			//MODIFY_SUPPLICANT_FOR_FREERTOS
	/**
...
#ifdef CONFIG_DPP			//MODIFY_SUPPLICANT_FOR_FREERTOS
	/**
...
struct wpa_ssid * wpa_config_add_network(struct wpa_config *config, char *ifname, int index);
#else
...
#endif /* SUPP_CONFIG_H */	//MODIFY_SUPPLICANT_FOR_FREERTOS
